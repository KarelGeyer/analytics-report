...
const ProductsByQuantity = () => {
    ...
    const saveProductNames = (e, res) => {
        formData.productsByQuantity.names.splice(res, 1, e.target.value)
    }

    const saveProductValues = (e, res) => {
        formData.productsByQuantity.values.splice(res, 1, e.target.value)
    }
...
export default ProductsByQuantity
